from feature_utils import compute_feature_for_one_seq, encoding_features, save_features
...
if __name__ == "__main__":
    ...
    for folder in os.listdir(DATA_DIR):
        ...
        for name in tqdm(afl.seq_list):
            ...
            # if (not whether_reload) and os.path.exists(os.path.join(INTERMEDIATE_DATA_DIR, f"{folder}-norm_center_dict.pkl")):
            #     print(f"skip one file")
            #     continue
